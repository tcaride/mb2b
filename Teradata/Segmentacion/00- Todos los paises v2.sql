...
/* 03: Agrupo por b2b_id first buy */
	...
	SELECT
	    ...
	    CASE WHEN b.cus_first_buy_no_bonif_autoof <= '2021-01-01' then 'OK'
	      WHEN b.cus_first_buy_no_bonif_autoof <= '2021-03-31' then '3Q'
	      WHEN b.cus_first_buy_no_bonif_autoof <= '2021-06-30' then '2Q'
