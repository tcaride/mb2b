...
DROP TABLE TEMP_45.LK_account_money_cust_mlc;
CREATE TABLE TEMP_45.LK_account_money_cust_mlc as (
SELECT
...
DROP TABLE TEMP_45.segmentacion_cust_mlc;
CREATE TABLE TEMP_45.segmentacion_cust_mlc as (
...
LEFT JOIN TEMP_45.LK_account_money_cust_mlc g ON a.cus_cust_id=g.cus_cust_id
...
WHERE COALESCE(y.CUS_TAGS, '') <> 'sink' AND a.sit_site_id = 'MLC' 
