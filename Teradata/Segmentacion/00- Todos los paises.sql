...
/* 06: Agrego company not company */
 
	 DROP TABLE TEMP_45.sell06_cust ;
	CREATE TABLE TEMP_45.sell06_cust as (
	  select
	  a.cus_cust_id_sel,
	  a.sit_site_id,
	  b.kyc_entity_type,
...
/* 07: Agrego customer y filtro sink */

	DROP TABLE TEMP_45.sell07_cust;
	CREATE TABLE TEMP_45.sell07_cust as (
	  select
	  a.cus_cust_id_sel,
	  a.sit_site_id,
	  a.kyc_entity_type,
